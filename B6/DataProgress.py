...
def dataTransform(raw_data, newStep, savePath, plot=False):
    ...
    raw_data.h = std_h.std(raw_data.h)
    ...
    #
    # # 返回数据和归一化器
    # return raw_data, std_b, std_h, std_freq, std_temp, std_loss
...
if __name__ == '__main__':
    # 设定路径
    raw_data_path = r"D:\essay\B6\materials"
    processed_data_dir = r"D:\essay\B6\Processed Training Data"
    newStep = 128
